      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <Link href="/" className="flex items-center">
              ...
              <span className="text-xl font-bold">EcoWaste Solutions</span>
            </Link>
            <p className="mt-4 text-gray-400">
              Sustainable waste management solutions for a cleaner, greener future.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link href="/waste-management" className="text-gray-400 hover:text-green-400">
                  Waste Management
                </Link>
              </li>
              <li>
                <Link href="/waste-management/propose" className="text-gray-400 hover:text-green-400">
                  Project Proposals
                </Link>
              </li>
              <li>
                <Link href="/feedback/report" className="text-gray-400 hover:text-green-400">
                  Issue Reporting
                </Link>
              </li>
            </ul>
          ...
          {/* Contact */}
          <div>
            <h3 className="text-sm font-semibold text-gray-300 uppercase tracking-wider">Get In Touch</h3>
            <ul className="mt-4 space-y-2">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">info@ecowaste.example.com</span>
              </li>
              <li className="flex items-start">
                <svg
                  className="h-5 w-5 text-green-400 mt-0.5 mr-2"
        ...
        <div className="mt-12 border-t border-gray-800 pt-8">
          <p className="text-gray-400 text-sm text-center">
            © {currentYear} EcoWaste Solutions. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
